...
export default function Home() {
  return (
    <section className='h-full px-3 sm:px-6 md:px-10 lg:px-60 py-2 md:py-2 flex flex-col justify-center gap-y-10 md:gap-y-16 lg:gap-y-28'>
      ...
      <Link href={'/about'} className='flex items-center text-lg'>
        Read more about me &mdash;&mdash;&gt;
      </Link>
      <span className='pb-4'>
        <Socials />
      </span>
