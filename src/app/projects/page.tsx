...
let projects = [
  {
    title: "GuideHub",
    desc: "GuideHub is a personal productivity management tool. Some features are still in process.",
    demo: "https://guide-hub.vercel.app/",
    github: "https://github.com/wyMinLwin/GuideHub",
    image: 'GuideHub.webp',
    tools: ["Next","TanStackQuery","Framer Motion","Redux Toolkit","Tailwind"]
  },
  {
      title: "React POS",
